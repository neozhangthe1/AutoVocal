...
clip_txt = TextClip(txt, color='yellow', align='West', fontsize=105,
                    font='STFangsong', method='label')
...
stars = ImageClip('../data/img/stars.jpg')
...
final.set_duration(8).write_videofile("starworms.avi", fps=25, codec="mpeg4")
...
# concatenate_videoclips(annotated_clips).write_videofile('tutorial.avi', fps=5, codec="mpeg4")
